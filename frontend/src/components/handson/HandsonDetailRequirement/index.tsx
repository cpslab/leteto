...
export type HandsonDetailRequirementProps = {
  require: string;
};
...
export const HandsonDetailRequirement = (
  props: HandsonDetailRequirementProps
): JSX.Element => {
  const { require } = props;
  return (
    <Grid container spacing={3} direction="column">
      ...
      <Grid item>
        <DescriptionPaper>{require}</DescriptionPaper>
      </Grid>
    </Grid>
  );
};
